...
public class V3CannotSlidePlayerActivity extends BaseActivity implements UizaIMAVideoV3.Callback {
    private UizaIMAVideoV3 uizaIMAVideoV3;
    private String entityIdDefaultVOD = "fe0c0ba1-dc1c-4d1e-96dd-9c5558c104bf";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        UizaV3Util.getDetailEntity((BaseActivity) activity, entityIdDefaultVOD, new UizaV3Util.Callback() {
            @Override
    ...
    private void setupVideo(Data data, String urlIMAAd, String urlThumnailsPreviewSeekbar, boolean isTryToPlayPreviousUizaInputIfPlayCurrentUizaInputFailed) {
        ...
        uizaIMAVideoV3.post(new Runnable() {
            @Override
            public void run() {
                uizaIMAVideoV3.init(V3CannotSlidePlayerActivity.this);
            }
        });
    }

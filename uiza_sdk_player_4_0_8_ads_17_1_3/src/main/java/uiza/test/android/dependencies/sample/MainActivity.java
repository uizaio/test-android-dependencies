package uiza.test.android.dependencies.sample;
...
import uiza.test.android.dependencies.R;
import uiza.test.android.dependencies.app.LSApplication;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.bt_test_ad).setOnClickListener(v -> {
